...
class Test_self(unittest.TestCase):
    ...
    def test_takeoff_lucky(self):
        ...
        posttype = '0'
        luckystate = '1'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '人工染色', 'luckytype': 'stone'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 0)
    # 测试下架已上架饰品
    def test_offshelf_lucky(self):
        ...
        posttype = '0'
        luckystate = '2'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '深红之网', 'luckytype': 'stone'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 1)
    # 测试佩戴饰品
    def test_wear_lucky_success(self):
        ...
        posttype = '0'
        luckystate = '00'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '外表生锈', 'luckytype': 'stone'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 3)
    # 测试佩戴饰品位置已满，佩戴失败
    def test_wear_lucky_fail(self):
        ...
        posttype = '0'
        luckystate = '00'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '枯焦之色', 'luckytype': 'stone'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 2)
    # 测试未输入上架饰品价格，上架失败
    def test_onshelf_lucky_fail(self):
        ...
        posttype = '0'
        luckystate = '01'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '传说', 'luckytype': 'stone', 'luckyprice': ''})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 4)
    # 测试上架饰品
    def test_onshelf_lucky(self):
        ...
        posttype = '0'
        luckystate = '01'
        response = self.client.post(url, data = {'posttype': posttype, 'luckystate': luckystate, 'luckyname': '传说', 'luckytype': 'stone', 'luckyprice': '1000.0'})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_takeoff_work(self):
        ...
        posttype = '1'
        workstate = '1'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '超导体', 'worktype': 'machine'})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_offshelf_work(self):
        ...
        posttype = '1'
        workstate = '2'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '狩猎网格', 'worktype': 'machine'})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_wear_work_success(self):
        ...
        posttype = '1'
        workstate = '00'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '深红之网', 'worktype': 'knife'})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_wear_work_fail(self):
        ...
        posttype = '1'
        workstate = '00'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '人工染色', 'worktype': 'knife'})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_onshelf_work_fail(self):
        ...
        posttype = '1'
        workstate = '01'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '传说', 'worktype': 'knife', 'workprice': ''})
        result = json.loads(response.data)
        self.assertIn('code', result)
    ...
    def test_onshelf_work(self):
        ...
        posttype = '1'
        workstate = '01'
        response = self.client.post(url, data = {'posttype': posttype, 'workstate': workstate, 'workname': '传说', 'worktype': 'knife', 'workprice': '1000.0'})
        result = json.loads(response.data)
        self.assertIn('code', result)
...
class Test_store(unittest.TestCase):
    ...
    def test_buy_self_fail(self):
        ...
        posttype = '0'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'luckyname': '深红之网', 'luckytype': 'crystal'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 0)
    # 测试不能购买已有的饰品
    ...
    def test_no_money_lucky(self):
        ...
        url = 'http://127.0.0.1:5000/store%3Fphonenum%3D' + phonenum
        posttype = '0'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'luckyname': '传说', 'luckytype': 'stone'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 2)
    # 测试购买饰品
    def test_buy_lucky(self):
        ...
        url = 'http://127.0.0.1:5000/store%3Fphonenum%3D' + phonenum
        posttype = '0'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'luckyname': '都市伪装', 'luckytype': 'crystal'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 3)
    # 测试不能购买已有的工具
    def test_buy_repeat_work(self):
        ...
        url = 'http://127.0.0.1:5000/store%3Fphonenum%3D' + phonenum
        posttype = '1'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'workname': '澄澈之水', 'worktype': 'pliers'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 4)
    # 测试金币不足，购买工具失败
    def test_no_money_work(self):
        ...
        url = 'http://127.0.0.1:5000/store%3Fphonenum%3D' + phonenum
        posttype = '1'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'workname': '传说', 'worktype': 'knife'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 5)
    # 测试购买工具
    def test_buy_work(self):
        ...
        url = 'http://127.0.0.1:5000/store%3Fphonenum%3D' + phonenum
        posttype = '1'
        response = self.client.post(url, data = {'posttype': posttype, 'user': user, 'workname': '青竹', 'worktype': 'shovel'})
        result = json.loads(response.data)
        self.assertIn('code', result)
        self.assertEqual(result['code'], 6)
